...
class TestApp(EWrapper, EClient):
    ...
    def calc_indicator_tf1_s(self):
        ...
        df_indicator_tf1_s['indicator_tf1_s'] = TA.WMA(df_indicator_tf1_s, self.mov_avg_length_tf1_s) # choose indicator here
    ...
    def tickDataOperations_req(self):
        ...
        # futures contract
        self.contract.symbol = 'TQQQ'   #ES #TQQQ
        self.contract.secType = 'STK'   #FUT #STK
        self.contract.exchange = 'SMART'  #GLOBEX #SMART
