...
TICKS_PER_CANDLE_TF1 = 512  #10 #34 #55 #89 #144 #233 #377
MOVING_AVG_PERIOD_LENGTH_TF1_S = 14 #9 #14 # slow timeframe (WMA)
MOVING_AVG_PERIOD_LENGTH_TF1_F = 14 #5 #9 # fast timeframe (WMA)
TICKS_PER_CANDLE_TF2 = 144 #5 #10 #34 #55 #89 #144 #233 #377
MOVING_AVG_PERIOD_LENGTH_TF2_S = 9 #9 #14 (WMA)
MOVING_AVG_PERIOD_LENGTH_TF2_F = 9 #5 #9 (WMA)
...
class TestApp(EWrapper, EClient):
    ...
    def calc_indicator_tf1_s(self):
        ...
        #print("Debug 0", self.df_indicator_tf1_s)
        #print("Debug 1", self.df_indicator_tf1_s['close'])
        #print("Debug 2", self.df_indicator_tf1_s['close'].diff(self.mov_avg_length_tf1_s))
        #print("Debug 3", self.df_indicator_tf1_s['close'].diff(self.mov_avg_length_tf1_s - 1))
        #print("Debug 4", self.df_indicator_tf1_s['close'].shift(self.mov_avg_length_tf1_s))
        #print("Debug 4", self.df_indicator_tf1_s['close'].shift(self.mov_avg_length_tf1_s - 1))
    ...
    def calc_indicator_tf1_f(self):
        ...
        #print("Debug 0", self.df_indicator_tf1_f)
        #print("Debug 1", self.df_indicator_tf1_f['close'])
        #print("Debug 2", self.df_indicator_tf1_f['close'].diff(self.mov_avg_length_tf1_f))
        #print("Debug 3", self.df_indicator_tf1_f['close'].diff(self.mov_avg_length_tf1_f - 1))
        #print("Debug 4", self.df_indicator_tf1_f['close'].shift(self.mov_avg_length_tf1_f))
        #print("Debug 4", self.df_indicator_tf1_f['close'].shift(self.mov_avg_length_tf1_f - 1))
        ...
        #return self.df_indicator_tf1_f['CCI']
    ...
    def calc_indicator_tf2_s(self):
        ...
        #return self.df_indicator_tf2_s['CCI']
    ...
    def calc_indicator_tf2_f(self):
       ...
       #Populating the DF with ROC
        ...
        #return self.df_indicator_tf2_f['CCI']
