...
MOVING_AVG_PERIOD_LENGTH_TF1_F = 2 #5 #9 # fast timeframe (WMA)
TICKS_PER_CANDLE_TF2 = 4 #5 #10 #34 #55 #89 #144 #233 #377
MOVING_AVG_PERIOD_LENGTH_TF2_S = 3 #9 #14 (WMA)
MOVING_AVG_PERIOD_LENGTH_TF2_F = 2 #5 #9 (WMA)
...
class TestApp(EWrapper, EClient):
    ...
    def tickDataOperations_req(self):
        ...
        # futures contract
        self.contract.symbol = 'ES'   #ES
        self.contract.secType = 'FUT'   #FUT
        self.contract.exchange = 'GLOBEX'  #GLOBEX
...
def main():
    app = TestApp()
    app.connect("127.0.0.1", port=7497, clientId=100)  # make sure you have a different client id for each ticker
